 ...
 * 发送方确认异步模式
 */
public class TopicProducerConfirmAsync {

	
	private final static String EXCHANGE_NAME_LOGS = "topic_logs";
	...
	public static void main(String[] args) throws IOException, TimeoutException, InterruptedException {
		...
		String queue = "queue2";
		queueRoutingKey.put(queue, "error.log");
		queueRoutingKey.put(queue, "info.log");
		queueRoutingKey.put(queue, "warning.log");
